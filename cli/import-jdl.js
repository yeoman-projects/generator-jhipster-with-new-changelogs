...
const waitUntil = require('generator-jhipster/cli/wait-until');
const { CLI_NAME, GENERATOR_NAME, logger, toString, getOptionsFromArgs, done, getOptionAsArgs } = require('generator-jhipster/cli/utils');
...
const runYeomanProcess = require.resolve('generator-jhipster/cli/run-yeoman-process.js');
