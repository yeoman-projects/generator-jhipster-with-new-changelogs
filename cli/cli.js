...
} = require('generator-jhipster/cli/utils');
const initAutoCompletion = require('generator-jhipster/cli/completion').init;
const SUB_GENERATORS = require('generator-jhipster/cli/commands');
        ...
        .action(args => {
            ...
            if (opts.cliOnly) {
                ...
                if (key === 'import-jdl') {
                    ...
                    require(`./generator-jhipster/cli/${key}`)(program.args, options, env);
                }
                /* eslint-enable */
            } else {
